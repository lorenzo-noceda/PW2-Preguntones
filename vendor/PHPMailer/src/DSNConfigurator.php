...
/**
 * Configure MailPresenter with DSN string.
 *
...
{
    /**
     * Create new MailPresenter instance configured by DSN.
     *
    ...
    /**
     * Configure MailPresenter instance with DSN string.
     *
     * @param PHPMailer $mailer MailPresenter instance
     * @param string    $dsn    DSN
     *
     * @return PHPMailer
     */
