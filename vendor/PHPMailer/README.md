...
require 'path/to/MailPresenter/src/Exception.php';
require 'path/to/MailPresenter/src/MailPresenter.php';
require 'path/to/MailPresenter/src/SMTP.php';
```
...
```php
<?php
//Import MailPresenter classes into the global namespace
...
try {
    ...
    $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = MailPresenter::ENCRYPTION_STARTTLS`
